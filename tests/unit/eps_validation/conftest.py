...
def consensus_validated_technical():
    ...
    return TechnicalEpsValidation(
        ...
        technical_consensus_eps=6.82,
        implied_eps_from_technicals=6.79,
...
def consensus_too_high_technical():
    ...
    return TechnicalEpsValidation(
        ...
        technical_consensus_eps=3.25,
        implied_eps_from_technicals=2.60,
...
def consensus_too_low_technical():
    ...
    return TechnicalEpsValidation(
        ...
        volume_trend_indicator="INCREASING",
        technical_consensus_eps=12.50,
        implied_eps_from_technicals=15.60,
