...
async def trade_ideas_task(symbol: str, earnings_analysis: ForwardPeValuation) -> Tuple[NoPositionTradeIdea, HasPositionTradeIdea]:
    """
    ...
    result: RunResult = await Runner.run(
        ...
        input=f"original_symbol: {symbol}, earnings_analysis: {earnings_analysis}")
