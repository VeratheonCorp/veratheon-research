...
from src.research.earnings_projections.earnings_projections_util import get_earnings_projection_data_for_symbol


@task(name="earnings_projections_fetch_task", persist_result=True)
