...
from src.research.trade_ideas.trade_idea_models import NoPositionTradeIdea

no_position_trade_idea_agent = Agent(
            name="No Position Trade Idea Analyst",      
            model="o4-mini",
            output_type=NoPositionTradeIdea,
            instructions="""
            You are a financial analyst providing a trade idea for a user who does not have a position in the given symbol.
            ...
            - Provide a trade idea for a user who does not have a position in the given symbol based on the analysis, with explanation.
